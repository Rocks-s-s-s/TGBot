...
async def get_message(message: types.Message):
    ...
    if message.text == 'расскажи историю':
        await message.answer('Както рас я не в значай сунул хуй в английский чай, в этот мик всё стало клёвым: хуй английским, чай хуёвым.')
